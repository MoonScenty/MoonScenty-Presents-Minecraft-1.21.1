...
현재 버전은 **0.2.14a**입니다. Create 기술 시대 다섯이 모두 들어간 알파 릴리즈이며, 변경 내역은 [CHANGELOG.md](CHANGELOG.md)에 있습니다.
...
```powershell
packwiz curseforge export -o "MoonScenty-Presents-0.2.14a.zip"
```
