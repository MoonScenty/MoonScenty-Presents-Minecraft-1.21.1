...
챕터는 여섯 개의 그룹으로 나눠 배치합니다. 현재 18개 챕터에 퀘스트 707개가 들어 있습니다.
...
| 황동 시대 | [QUEST_BRASS_AGE.md](QUEST_BRASS_AGE.md) | 설계 완료, 구현 대기 |
| 산업 시대 | 미작성 | — |
| 원자력 시대 | 미작성 | — |
...
기술 축에서 남은 일은 황동 시대 구현과 산업·원자력 시대의 설계입니다. 챌린지 미션 챕터도 비어 있습니다.
...
- FTB Quests의 여섯 그룹 18개 챕터가 오류 없이 열리고 퀘스트 707개의 배치, 목표 판정과 의존 관계가 정상적으로 작동하는지
