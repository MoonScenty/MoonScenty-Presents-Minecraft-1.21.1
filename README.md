...
현재 버전은 **0.2.6a**입니다. Create 기술 시대 다섯이 모두 들어간 알파 릴리즈이며, 변경 내역은 [CHANGELOG.md](CHANGELOG.md)에 있습니다.
...
- **Toni's Immersive Lanterns** — 랜턴을 손에 들거나 허리에 매달아 다닐 수 있게 합니다.
...
```powershell
packwiz curseforge export -o "MoonScenty-Presents-0.2.6a.zip"
```
