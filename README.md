...
현재 버전은 **0.2.8a**입니다. Create 기술 시대 다섯이 모두 들어간 알파 릴리즈이며, 변경 내역은 [CHANGELOG.md](CHANGELOG.md)에 있습니다.
...
- **Dynamic Lantern** — 랜턴을 허리에 매달아 다닐 수 있게 합니다. 장신구 슬롯이 하나 늘고, 걸음에 맞춰 랜턴이 흔들리며 주변을 밝힙니다.
...
```powershell
packwiz curseforge export -o "MoonScenty-Presents-0.2.8a.zip"
```
